...
4. [AICAR’s Core Solutions](#4-aicars-core-solutions)  
...
3. **Community Lending Pool**  
   - Funded by ecosystem allocations and future inflows.  
...
|:---------------|-----------:|---------------:|:-------------------------------------------------------------------------------------|
| **LBP Sale**   | 10%        | 100,000,000    | Offered during a Liquidity Bootstrapping Pool, aiming to raise ~$1,000,000           |
...
1. **Token Allocation**: 100,000,000 AICAR (10% of total supply)  
2. **Target Raise**: **\$1,000,000** (not guaranteed; final amount depends on demand)  
3. **Mechanism**: A **Dutch-auction style** Liquidity Bootstrapping Pool (LBP) on Solana, where AICAR starts at a higher price and gradually trends lower as pool weights shift.  
4. **Duration**: Typically runs 3–5 days; final window TBA.  
5. **Collateral**: Paired with USDC in the LBP to enable price discovery.  
6. **No Hard Cap**: The actual raise depends on participant demand and how quickly they buy during the price-shifting period.

---

### 6.4. Use of LBP Proceeds

Upon concluding the LBP, the project aims to allocate funds as follows, **assuming a target of \$1,000,000**:

| Category               | % of Funds | Amount (USD) | Primary Use Cases                                                                                 |
|:-----------------------|----------:|------------:|:--------------------------------------------------------------------------------------------------|
| **Liquidity Pool**     | 40%       | \$400,000   | Ensures a **deep liquidity** buffer post-LBP to maintain smoother trading and price stability.    |
| **Marketing & Community** | 27.5% | \$275,000   | Funds influencer campaigns, conference booths, social ads, referral programs, brand building.      |
| **Development**        | 22.5%     | \$225,000   | Covers AI enhancements, security audits, front-/back-end builds, and feature rollouts.             |
| **Ops & Legal**        | 10%       | \$100,000   | Addresses operational overhead, legal fees, compliance, and unforeseen costs.                      |

**Total**: 100% = **\$1,000,000** (subject to actual LBP outcome).

---

### 6.5. Liquidity Setup & Listing Price

While the LBP itself handles **initial price discovery**, the team will subsequently establish on-chain liquidity for AICAR. Any portion of the **40%** above allocated to “Liquidity Pool” can be used to:

- **Pair with additional AICAR** from the 25% general liquidity allocation.  
- **Maintain a stable listing price** above the LBP’s final clearing price.  
- **Lock or vest** some liquidity tokens for community confidence.

This approach ensures post-LBP trading remains accessible and less prone to extreme volatility.
...
1. **Staking**  
   - Users can stake AICAR to earn yields from borrower interest.  
   - Ecosystem & Rewards allocations also boost APY to attract early adopters.

2. **Dealership Subscriptions**  
   - Monthly or annual fees paid in stablecoins or AICAR to unlock AI-driven financing tools.  
   - A fraction of these fees flows into a reward pool for stakers, aligning community and platform growth.
...
- **Treasury Allocations**: The 17.5% DAO/Treasury can fund expansions, marketing pushes, or strategic grants via on-chain governance.  
...
2. **Q1 – Q2 2025**  
   - **LBP Launch** on Solana, offering 10% of total supply for broad distribution.  
...
4. **Q1 2026**  
   ...
   - **Subscription Revenue Sharing** to holders goes live.  
...
- **Tokenomics**: A 10% LBP allocation, advanced liquidity planning, and meaningful staking/subscription rewards align all stakeholders.  
